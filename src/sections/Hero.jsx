...
const Hero = () => {
    ...
    const text = `I help brands build beautiful digital 
    products that create lasting impressions
    By providing them an unfair advantage`;

  return (
    <section id="home" className="flex flex-col justify-end min-h-screen">
      <AnimatedHeaderSection text={text} title1={"Abdullah"} title2={"Nadeem"} subtitle={"404 Bugs Not Found"} textColor={"text-black"}/>
